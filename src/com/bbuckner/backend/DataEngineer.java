...
public class DataEngineer {
    ...
    public final DoubleProperty rpmAtMaxTorque = new SimpleDoubleProperty(0);
    ...
    public final DoubleProperty carMaxTorque = new SimpleDoubleProperty(0);
    ...
    private DataEngineer() {
        isRaceOn.addListener((observable, oldValue, newValue) -> {
            System.out.println("isRaceOn:" + newValue);
            if(newValue.intValue() == 0){
                System.out.println("RPM At Max Torque = " + rpmAtMaxTorque.getValue());
                System.out.println("Max Torque = " + carMaxTorque.getValue());
                System.out.println("Max RPM = " + rpmMaxMeasured.getValue());
            }
        });
        ...
        raceLapNumber.addListener((observable, oldValue, newValue) -> {
            if (isRaceOn.getValue()==1){
                if (newValue.intValue()==0){
                    ...
                    carMaxTorque.setValue(0);
                    rpmAtMaxTorque.setValue(0);
